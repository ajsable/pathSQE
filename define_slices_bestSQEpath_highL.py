...
def make_slices_aiden(extra=''):
   ...
   # Looking for BZ w/ most q coverage and phonon dispersions present.
    ...
    description={'QDimension0':'1,0,0',
                 ...
                 'Dimension2Binning':'3.85,4.15',
                 'Dimension3Name':'DeltaE',
                 'Dimension3Binning':'-35.5,1,66.5',
                 #'SymmetryOperations':'P 4/nmm',
                 'SymmetryOperations':'x,y,z',
                 'Name':'FeSi_300K_Ei70meV_FR_hL_GAMMA2X'+extra}#;-x,y,z;x,y,-z;-x,y,-z',
   ...
   ## GAMMA>X segment for plotting along a path [best BZ, around 1.5-2]
    description={'QDimension0':'1,0,0',
                 ...
                 #'SymmetryOperations':'P 4/nmm',
                 'SymmetryOperations':'x,y,z',
                 'Name':'FeSi_300K_Ei70meV_Best_hL_GAMMA2X'+extra}#;-x,y,z;x,y,-z;-x,y,-z',
    dsl.append(description)
    ...
    description={'QDimension0':'1,0,0',
                 ...
                 'Name':'FeSi_300K_Ei70meV_FR_hL_X2M'+extra}
    dsl.append(description)
    ...
    description={'QDimension0':'1,0,0',
                 ...
                 #'SymmetryOperations':'P 4/nmm',
                 'SymmetryOperations':'x,y,z',#;-x,y,z;x,y,-z;-x,y,-z',
                 'Name':'FeSi_300K_Ei70meV_Best_hL_X2M'+extra}
    dsl.append(description)
    ...
    description={'QDimension0':'1,1,0',
                 ...
                 #'SymmetryOperations':'P 4/nmm',
                 'SymmetryOperations':'x,y,z',#;-x,y,z;x,y,-z;-x,y,-z',
                 'Name':'FeSi_300K_Ei70meV_FR_hL_M2GAMMA'+extra}
    dsl.append(description)
    ...
    description={'QDimension0':'1,1,0',
                 ...
                 #'SymmetryOperations':'P 4/nmm',
                 'SymmetryOperations':'x,y,z',#;-x,y,z;x,y,-z;-x,y,-z',
                 'Name':'FeSi_300K_Ei70meV_Best_hL_M2GAMMA'+extra}
    dsl.append(description)
    ...
    description={'QDimension0':'1,1,1',
                 ...
                 #'SymmetryOperations':'P 4/nmm',
                 'SymmetryOperations':'x,y,z',#;-x,y,z;x,y,-z;-x,y,-z',
                 'Name':'FeSi_300K_Ei70meV_FR_hL_GAMMA2R'+extra}
    dsl.append(description)
    ...
    description={'QDimension0':'1,1,1',
                 ...
                 #'SymmetryOperations':'P 4/nmm',
                 'SymmetryOperations':'x,y,z',#;-x,y,z;x,y,-z;-x,y,-z',
                 'Name':'FeSi_300K_Ei70meV_Best_hL_GAMMA2R'+extra}
    dsl.append(description)
    ...
    description={'QDimension0':'1,0,1',
                 ...
                 #'SymmetryOperations':'P 4/nmm',
                 'SymmetryOperations':'x,y,z',#;-x,y,z;x,y,-z;-x,y,-z',
                 'Name':'FeSi_300K_Ei70meV_FR_hL_R2X'+extra}
    dsl.append(description)
    ...
    description={'QDimension0':'1,0,1',
                 ...
                 #'SymmetryOperations':'P 4/nmm',
                 'SymmetryOperations':'x,y,z',#;-x,y,z;x,y,-z;-x,y,-z',
                 'Name':'FeSi_300K_Ei70meV_Best_hL_R2X'+extra}
    dsl.append(description)
